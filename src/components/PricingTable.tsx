...
function PricingTable( {title, description, price, listAdvantage }: PricingTableProps){
  return (
    ...
    <div className="border-solid border-2 rounded-md border-gray-400 shadow-md border-opacity-10 p-4">
      ...
      <div className="mt-8">
        <button className='text-white bg-textSoft rounded-md p-2 font-semibold border-solid border-2 border-white w-[100%]'>
